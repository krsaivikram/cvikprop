...
function preload(){
  ...
  red = loadImage("sprites/red.jpg");
 blue = loadImage("spritesblue.jpg");
 yellow = loadImage("spritesyellow.jpg");
  green = loadImage("spritesgreen.jpg");
}
function setup() {
 ...
 restart = createSprite(500,500,20,40);
    ...
    Red = createSprite(red,1000+100,540-100);
...
function draw() {
 ...
 if(arrow1.body.position.x===700&&arrow1.body.position.y>510&&arrow1.body.position.y<535){
   points+=10
 }
 if(arrow1.body.position.x===700&&arrow1.body.position.y>440&&arrow1.body.position.y<465){
  points+=9
}
if(arrow1.body.position.x===700&&arrow1.body.position.y>415&&arrow1.body.position.y<440){
  points+=9
}
if(arrow1.body.position.x===700&&arrow1.body.position.y>465&&arrow1.body.position.y<490){
  points+=9
}
if(arrow1.body.position.x===700&&arrow1.body.position.y>390&&arrow1.body.position.y<415){
   points+=9
}
if(arrow1.body.position.x===700&&arrow1.body.position.y>490&&arrow1.body.position.y<515){
   points+=9
}
if(arrow1.body.position.x===700&&arrow1.body.position.y>370&&arrow1.body.position.y<385){
   points+=9
}
//box.display();
//b.display();
